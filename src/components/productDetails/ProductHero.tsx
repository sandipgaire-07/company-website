      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
          ...
          <Button
            ...
            nativeButton={false}
            size="lg"
            className="mt-8 h-auto rounded-md bg-gradient-to-r from-[#072069] to-[#0EA5E9] px-6 py-3 text-white shadow-lg shadow-[#0EA5E9]/20 transition-all hover:-translate-y-0.5 hover:shadow-xl"
          />
        </div>
      </div>
    </section>
