...
export default function ProductStats({ stats }: { stats: ProductStat[] }) {
  return (
    <section className="bg-[#F8FAFC] px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {stats.map((stat) => (
            <Card key={stat.id} className="border-0 bg-white shadow-sm ring-1 ring-[#DADEE7] transition-all hover:-translate-y-1 hover:shadow-lg">
