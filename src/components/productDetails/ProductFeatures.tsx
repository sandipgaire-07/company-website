        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:mt-16 lg:grid-cols-3">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                {/* Top gradient line */}
                <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#072069] to-[#0EA5E9] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                ...
                <CardContent className="relative p-6 sm:p-7">
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="relative">
                      <div className="absolute inset-0 rounded-2xl bg-[#0EA5E9]/10 blur-xl transition-all duration-300 group-hover:bg-[#0EA5E9]/20" />

                      <div className="relative flex size-12 items-center justify-center rounded-2xl bg-[#EBF0FA] text-[#072069] transition-all duration-300 group-hover:bg-gradient-to-br group-hover:from-[#072069] group-hover:to-[#0EA5E9] group-hover:text-white">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <div className="h-px flex-1 bg-[#DADEE7] transition-colors duration-300 group-hover:bg-[#0EA5E9]/30" />

                    <ArrowUpRight className="ml-4 size-4 text-[#DADEE7] transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-[#0EA5E9]" />
                  </div>
                </CardContent>
              </Card>
            );
