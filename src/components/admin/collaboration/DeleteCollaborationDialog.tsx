...
type DeleteCollaborationDialogProps = {
  collaborationName: string;
};

export default function DeleteCollaborationDialog({
  collaborationName,
}: DeleteCollaborationDialogProps) {
  function handleDelete() {
    console.log("Delete collaboration:", collaborationName);
      ...
      <AlertDialogTrigger
        render={
          <Button
            ...
            aria-label={`Delete ${collaborationName}`}
          />
        }
      >
